#!/usr/bin/perl
{
    ...
    %CAP = (
        ...
        '1' => {  # 0x02
            '_name' => 'Starlight',
            '_visible_name' => 'Starlight',
            '_key' => 'starlight_user',
            '_account_type' => 'starlight',
        ...
        '2' => {  # 0x04
            '_name' => 'Golden',
            '_visible_name' => 'Golden',
            '_key' => 'golden_user',
            '_account_type' => 'golden',
            %CAP_PAID,
            'userpics' => 25
        },
        '3' => {  # 0x08
            '_name' => 'Mastermind',
            '_key' => 'mastermind_user', # Some things expect that key name
            '_visible_name' => 'Mastermind',
            '_account_type' => 'mastermind',
            '_refund_points' => 0,
            %CAP_PAID,
            'userpics' => 50
        },
        '4' => {  # 0x10
            '_name' => 'Bejeweled',
            '_key' => 'bejeweled_user',
            '_visible_name' => 'Bejeweled',
            '_account_type' => 'bejeweled',
            '_refund_points' => 0,
            %CAP_PAID,
            'userpics' => 150
        },
